...
// into HTTP responses. These routes currently have no Service to call —
// health-check and version logic is trivial enough to stay in the route
// itself, a deliberate, documented exception, not an oversight.
